...
From the identified approaches, only the one by Nayrolles et. al. implemented this technique \cite{Nayrolles2018}, however there exist other works in the literature where such techniques have been explored without a focus on Commit Validation. %such as the work by Pan et. al. and the work by Kim et. al \cite{Nayrolles2018, Kim2013, Pan2009}.
...
Unlike Commit Guru and Unusual Commits, Kamei did not publish an openly usable program, thus CI capability or any technological information cannot be reported on.
