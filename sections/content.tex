...
The paper concludes with an overview of related surveys on the topic in Section \ref{sec:relatedsurveys} and the concluding Section \ref{sec:conclusions}.
...
\begin{table}[p]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		Commit Abnormality Score & \pointyes & \pointyes & \pointno & \pointyes & \pointyes \\
		...
		\textit{CI Capability} & & & & & \\
		Precommit Hook & \pointyes & \pointno & \pointno & \pnotapplicable & \pnotapplicable \\
