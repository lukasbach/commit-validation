...
Table \ref{tab:perfclever} describes the findings from Nayrolle's paper \cite{Nayrolles2018}, while table \ref{tab:perfdeeper} describes the findings from Yang's paper \cite{Yang2015}.
...
\todo{Tables, description of tables}
